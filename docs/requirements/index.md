...
**Product:** gitlab-nginx (POSIX `/bin/sh` CLI + GitLab/Nginx domain)  
...
| `RQ-SHELL-CLI-STORAGE` | requirement-shell-cli-storage | Cache folder + persistence folder resolve (per-user isolation, main wire, about fields) | shell | Active | `requirement-shell-cli-storage.md` | 2026-08-30 |
...
| `RQ-SHELL-SUDO-COMMAND` | requirement-shell-sudo-command | In-tool sudo wrap + studied allow table | shell | Active | `requirement-shell-sudo-command.md` | 2026-09-06 |
