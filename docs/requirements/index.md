...
| `RQ-DOMAIN-GITLAB-NGINX` | requirement-domain-gitlab-nginx | GitLab + external Nginx domain (run/domains/email/nginx-conf/ssh-hostname; help + about pillars) | domain | Active | `requirement-domain-gitlab-nginx.md` | 2026-08-11 |
